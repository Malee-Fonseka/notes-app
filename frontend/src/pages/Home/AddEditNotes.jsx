...
const AddEditNotes = ( {noteData, getAllNotes, type, onClose, showToastMessage } ) => {
  ...
  return (
    <div className="relative">
      ...
      <button className="w-full text-sm bg-primary text-white rounded my-1 hover:bg-blue-600 font-medium mt-5 p-3" onClick={handleAddNote}>{type === "edit" ? "UPDATE" : "ADD"}</button>
    </div>
  )
}
